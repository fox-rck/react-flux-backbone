...
module.exports = React.createClass({
    ...
    render: function() {
        ...
        var taskComplete = this.props.todo.complete ? "icon-checkbox-checked" : "icon-checkbox-unchecked";
        ...
        return <div className="row no-gutter">
                    <div className="col-xxs-12">
                        <div className="themed-blerp green" onClick={this.toggleOptionCard} >
                            <div>
                                <div className="right">
                            ...
                            <div className="clear" />
                                ...
                                <div className="left todo-checkbox">               
                                    <button className="link-btn" onClick={this.onToggle}>
                                        <i className={taskComplete} />
                                    </button>
                                </div>
                                <div className="body">
                                    <a href={ownerUrl} className="user-name">{this.props.user.FN} {this.props.user.LN}</a>
                                    <div className="copy" style={styles} onClick={this.onToggle}>{this.props.todo.text}</div>
                                </div>
