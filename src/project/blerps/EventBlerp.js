...
module.exports = React.createClass({
    ...
    "JUL", "AUG", "SEP", "OCT", "NOV", "DEC" ];
        ...
        var eventDate = new Date(this.props.todo.event_date);
        ...
        return <div className="row no-gutter">
                    <div className="col-xxs-12">
                        <div className="themed-blerp red" onClick={this.toggleOptionCard} >
                            <div>
                                <div className="right">
                                ...
                                <div className="left event-summary">               
                                ...
                                <div className="body">
                                    <a href={ownerUrl} className="user-name">{this.props.user.FN} {this.props.user.LN}</a>
                                      ...
                                      <div className="copy" style={styles}>{this.props.todo.text}
                                      </div>
                                </div>
